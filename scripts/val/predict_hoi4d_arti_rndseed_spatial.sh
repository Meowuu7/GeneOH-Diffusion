...
export resume_diff=""
export rnd_noise=""
export save_dir="/data1/xueyi/eval_save/HOI_Rigid/ToyCar"
...
export single_seq_path="/home/xueyi/sim/GeneOH-Diffusion/data/hoi4d/ToyCar/case3/merged_data.npy"
export start_idx=0
export test_tag="rep_res_jts_spatial_hoi4d_rigid_bowl_t_200_st_idx_0__sel_idx_0_thetadim_45_"
export theta_dim=45
...
export prev_test_tag="jts_hoi4d_t_400_test_"
