...
def vis_predicted_joints_grab(predicted_info_fn, optimized_fn=None):
    ...
    if optimized_fn is not None:
        ...
        # optimized_tar_hand_verts = data['optimized_tar_hand_verts']
...
if __name__=='__main__':
    ...
    predicted_info_fn = f"./data/grab/result/predicted_infos_seq_{seq_idx}_seed_{seed}_tag_{tag}.npy"
    optimized_fn = f"./data/grab/result/optimized_infos_sv_dict_seq_{seq_idx}_seed_{seed}_tag_{tag}.npy"
    ### get file paths ###
    
    vis_predicted_joints_grab(predicted_info_fn, optimized_fn)
