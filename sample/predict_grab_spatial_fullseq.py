...
def main():
    ...
    for cur_seed in tot_test_seeds:
        ...
        for st_fr in st_idxes:
            ...
            # f"predicted_infos_seq_{seq_idx}_seed_{args.seed}_st_{args.start_idx}_tag_{args.test_tag}.npy"
            args.predicted_info_fn = f"predicted_infos_seq_{seq_idx}_seed_{args.seed}_st_{args.start_idx}_tag_{prev_test_tag}.npy" 
